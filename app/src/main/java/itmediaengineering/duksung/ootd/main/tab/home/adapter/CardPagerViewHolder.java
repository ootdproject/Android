...
public class CardPagerViewHolder extends Fragment {
    ...
    public void onAttach(Context context) {
        ...
        if(context instanceof CardPagerCallback){
            callback = (CardPagerCallback) context;
        }
    }
    ...
    //public static CardPagerViewHolder newInstance(MovieInfo data, int index){
    public static CardPagerViewHolder newInstance(){

        CardPagerViewHolder fragment = new CardPagerViewHolder();
